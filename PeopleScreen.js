...
export default function PeopleScreen ({ navigation }) {
    ...
    const PEOPLE_SCREEN_DATA = [
        ...
        },
        {
            ...
            username: 'Lucas',
            convo: require('./assets/Images/lucas-convo.jpg'),
            time: '5m ago',
            profilePic: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR8DUUfF_LxZQBVCj_aKb53zZD9czoEsy8A3g&usqp=CAU',
            id: '1',
            read: 'true',
            location: 'Palo Alto, CA',
            distance: '1.2 miles',
        ...
        },
        {
            ...
            username: 'Nichole',
            convo: require('./assets/Images/nichole-convo.jpg'),
            time: '47m ago',
        ...
        },
        {
            ...
            donated: '11',
            listings: '2',
            bio: 'Student @ Cal studying EECS',
            rating: require('./assets/Icons/bigstars-yellow-50.png'),
            givingAway: [
                {
                    id: '1',
                    title: 'Cracked Cell Phone',
                    image: 'https://images.unsplash.com/photo-1498582750569-89914abe05e4?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MjB8fGJyb2tlbiUyMGl0ZW1zfGVufDB8MnwwfHw%3D&auto=format&fit=crop&w=900&q=60',
                    location: 'Palo Alto, CA',
                    distance: '1.2 miles',
                    story: 'a phone i found on the side of the road',
                    exchangeDetails: 'down to meet anywhere in PA',
                },
                {
                    id: '2',
                    title: 'Broken Phone',
                    image: 'https://images.unsplash.com/photo-1595392030002-dd3bcc0ca05a?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MzB8fGJyb2tlbnxlbnwwfDJ8MHx8&auto=format&fit=crop&w=900&q=60',
                    location: 'Palo Alto, CA',
                    distance: '1.2 miles',
                    story: 'a phone i took apart for a class im taking',
                    exchangeDetails: 'down to meet anywhere in PA',
                },
                {
                    id: '3',
                    title: 'Lots of Phones',
                    image: 'https://media.istockphoto.com/id/1372577438/photo/old-electronic-devices-on-a-dark-background-the-concept-of-recycling-and-disposal-of.jpg?s=612x612&w=0&k=20&c=IkeqihbFY6IBvWDK5pgBXYRJYmR3qIBQdsdtghnbHKk=',
                    location: 'Palo Alto, CA',
                    distance: '1.2 miles',
                    story: 'my dearest phone collection',
                    exchangeDetails: 'down to meet anywhere in PA',
                },
            ],
            art: [
            ...
            <View style={styles(item).messageContainer}>
                ...
                <View style={styles(item).textHalf}>
                    <View style={styles(item).top}>
                        <Text style={styles(item).messageTitle}>{item.username}</Text>
